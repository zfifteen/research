...
The trial presented preliminary Phase I results at the 2025 American Society of Clinical Oncology Annual Meeting. Among nine evaluable patients treated at the time of data cutoff, the combination demonstrated acceptable safety with adverse events consistent with the known profile of PD-1 inhibitors. Common toxicities included grade one or two fatigue, arthralgia, and nausea. Two patients experienced grade three immune-related adverse events, specifically colitis and pneumonitis, both manageable with standard immunosuppression protocols. Notably absent were high-grade neurologic toxicities, suggesting the intermittent ivermectin dosing successfully avoided central nervous system accumulation.

Preliminary efficacy data showed one partial response among the nine patients, yielding an objective response rate of eleven percent. Four patients achieved stable disease, four had progressive disease, and follow-up remained insufficient for progression-free survival or overall survival analysis. The single responding patient had PD-L1-negative disease at baseline and had previously progressed on pembrolizumab plus chemotherapy, suggesting potential restoration of checkpoint inhibitor sensitivity through the immune priming approach.
