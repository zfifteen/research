...
# -*- coding: utf-8 -*-
"""
generate_meshes_v3.py — STRONG DISTORTION VERSION
Produces proper regime differentiation for the phase-transition validation
"""
